...
test('Assertion Demo', async({page})=>{
    ...
    await expect.soft(page.getByPlaceholder('Email address or phone number',{exact:true})).toBeVisible();
    ...
    //Soft Assertion - With Soft - In case of soft assertion the program do not stop 

    //Hard Assertion - Without Soft - In case of hard assertion the program stop
})
